	...
	public static void main(String[] args) {
		/*
		  ...
		  if : 조건을 만족하는 실행문을 실행 후, if 문을 빠져나온다.
			...
			- if (조건1) {			//조건1이 참일 때, 실행문1을 실행
					실행문1;
			  } else if (조건2) {	//조건2가 참일 때, 실행문2를 실행
			  		실행문2;
			  } else if (조건3) {	//조건3가 참일 때, 실행문3를 실행
			  		실행문3;
			  } 
			  
			  .....
			  
			  } else {				//위의 모든 조건을 만족하지 않을 땐, 실행문 10을 실행
			  		실행문10;
			  }
		...
		//if 조건에서 실행문이 1개 일때는 중괄호를 생략 할 수 있다. (**************주의요함******************)
			//권장사항 : 중괄호 명시 후 사용.
		System.out.println("==========================================");
		if (5 < 3) 			//만약 if가 false 가 뜨고, 중괄호를 생략하면 false 실행문 출력!!!!!!!!
		...
		//		- 기본 자료형 (8가지) : 초기값을 할당하지 않으면 오류 (boolean, byte, short, int, long, float, double, char)
		...
		if(c > 90) {								//false
			...
			System.out.println("B학점 입니다.");		//실행문 실행 후 if 문을 빠져나옴
		} else if (c >= 70) {
