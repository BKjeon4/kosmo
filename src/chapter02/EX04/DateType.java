...
public class DateType {
	...
	public static void main(String[] args) {
		...
		System.out.println("bb의 출력값" + bb);  // 왜 +?
		...
		short abc;
		abc = 32767;		//short 변수의 마지막 값
		abc = (short)32768;		// - 32768
		System.out.println("abc 변수의 출력 값" + abc);
		
		
		int ddd;		// -4,294,967,296 ~ + 4,294,967,2967‬
		ddd = 1234567891;
		System.out.println(ddd);
		
		long eee;
		eee = 1234567891234567L;	//정수 long 값을 넣을 때는 소문자 또는 대문자 L 을 반드시 붙여야 한다.
