...
public class TypeCasting_2 {
	...
	public static void main(String[] args) {
		...
		//byte와 short를 연산을 하게 되면 정수(int)로 처리하여야 함************
		byte data1 = 3;
		byte data2 = 5;
		...
		//다른 자료형 간의 연산	(작은 자료형이 큰 자료형으로 자동으로 업캐스팅되어 연산 됨)
		
		 //int value6 = 5 + 3.5;			//오류발생
		int value6 = (int) (5 + 3.5); 		//int로 다운 캐스팅
		
		double value7 = 5 + 3.5; 			//5가 double 로 자동으로 업캐스팅 됨
		int value7_1 = 5 + (int)3.5;
		
		double value8 = 5 /2.0;
		byte data33 = 3;
		short data44 = 5;
		int value9 = data33 + data44;		//*****주의: byte 나 short 는 int 로 처리
