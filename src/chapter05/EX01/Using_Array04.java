...
public class Using_Array04 {
	...
	public static void main(String[] args) {
		...
		// 1. 배열 선언과 초기화
		int[]a = new int[5];		// a 는 배열 자료형이자 참조 자료형
			//int 배열변수([]) a를 생성
		...
		//입력
		for (int i = 0, j = 100; i <5; i++, j+=100) {	// i : index (0,1,2,3,4) / j=j+100
			a[i] = j;
		...
		//각 방의 값을 입력
		for (int i = 0, j = 1000; i <5; i++, j+=1000) {	// i : index (0,1,2,3,4) / j=j+100
			a[i] = j;
		}
		...
		// 4. 출력 : Arrays.toString(a)	: Arrays 객체의 toString() 메소드[method](함수) 
