...
public class Using_Read_Array_2D {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr1[0].length);	// 3 <-- 0번 행의 열의 갯수
		System.out.println(arr1[1].length);	// 3 <-- 1번 행의 열의 갯수
		System.out.println("=========================================");
		...
		// 2. for 문을 사용해서 출력 : 2차원 배열 이중 for ( for 문 내의 for 문)
