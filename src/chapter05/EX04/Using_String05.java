...
public class Using_String05 {
	...
	public static void main(String[] args) {
		...
		//	2. literal로 변수의 값을 넣을 경우 동일한 문자열은 주소를 공유
		//	3. 객체 자체를 출력할 때 객체의 주소가 출력되는 것이 아니고 객체의 값이 출력 
		// 			(toString() method 가 재정이 되어 있다.)
		//	4. 다양한 method가 정의되어 있다.
		...
		String str5 = str3.concat(str4);	// + 와 같음		*concat = concatenate 잇다 연결시키다; 연쇄시키다
